        ...
        {axie.map((photo: any, index: any) => (
          <React.Fragment key={index}>
            <Grid item xs={4}>
              <Link
                href={
                  `https://marketplace.axieinfinity.com/axie/` + axie[index].id
                }
      ...
      <TableRow sx={{ "& > *": { borderBottom: "unset" } }}>
        ...
        <TableCell align="left" className={styles.row150}>
          <Grid item>
            ...
            <ListItem disablePadding>
              <Typography className={styles.bagiprofit}>
                {row.managerpshare}%
              </Typography>
            </ListItem>
          </Grid>
              ...
              <Box className={styles.collapseError}>
                ...
                >
                  <Grid item xs={12} sx={{ padding: "30px" }}>
                    <Typography
                      sx={{ color: "red", fontSize: 30, fontWeight: "bold" }}
                    >
                      Adress Ronin tidak ditemukan! Pastikan tidak ada spasi dan
                      coba update data!
                    </Typography>
                  </Grid>
                </Grid>
